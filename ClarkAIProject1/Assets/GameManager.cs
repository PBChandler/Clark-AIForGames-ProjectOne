...
public class GameManager : MonoBehaviour
{
    ...
    public bool cubesShouldStayUnfrozen = false;
    ...
    public void Update()
    {
        // debugging: toggle all cubes unfrozen with spacebar
        // if (Input.GetKeyDown(KeyCode.Space))
        // {
        //     cubesShouldStayUnfrozen = !cubesShouldStayUnfrozen;
        //     foreach (SpawnableCube cube in cubes)
        //     {
        //         if (cube != null && cube.rb != null)
        //             cube.rb.isKinematic = !cubesShouldStayUnfrozen;
        //     }
        // }
    }
